...
export default function CopyLiveChart() {
  ...
  // const [exchange,setExchange] = useChartStore((s) => s.exchange);
  // const [symbol,setSymbol] = useChartStore((s) => s.symbol);
  // const [timeframe, setTimeframe] = useChartStore((s) => s.timeframe);
